...
if (is_numeric($on_behalf_id)){
  ...
  if(ttUserHelper::getUserName($on_behalf_id) && $user->can('manage_users')){
	$user->setOnBehalfUser($on_behalf_id);
  }
}
...
if ($time_rec['invoice_id']) die($i18n->get('error.entry_invoiced'));
