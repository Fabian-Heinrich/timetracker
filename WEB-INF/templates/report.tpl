...
<table class="x-scrollable-table">
  ...
  {if $bean->getAttribute('chclientnumber')}<th class="clientnumber-header">{$i18n.label.client_number}</th>{/if}
  ...
  {if $bean->getAttribute('chbillable')}<th>{$i18n.label.billable}</th>{/if}
  ...
  <tr>
    <th class="invoice-label">{$i18n.label.subtotal}</th>
        ...
        {if $bean->getAttribute('chclientnumber')}<td class="text-cell subtotal-cell">{$subtotals[$prev_grouped_by]['clientnumber']|escape}</td>{/if}
  ...
  <tr>
    ...
    {if $bean->getAttribute('chclientnumber')}<td class="text-cell">{$item.client_number|escape}</td>{/if}
    ...
    {if $bean->getAttribute('chbillable')}<td class="text-cell">{$item.billable|escape}</td>{/if}
  ...
  <tr>
    ...
    {if $bean->getAttribute('chclientnumber')}<td class="text-cell subtotal-cell">{$subtotals[$cur_grouped_by]['clientnumber']|escape}</td>{/if}
