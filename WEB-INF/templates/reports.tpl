...
{if $show_client}
  ...
  <tr><td><div class="small-screen-form-control-separator"></div></td></tr>
  <tr class = "small-screen-label"><td><label for="chclientnumber">{$i18n.label.client_number}:</label></td></tr>
  <tr>
    <td class="large-screen-label"><label for="chclientnumber">{$i18n.label.client_number}:</label></td>
    <td class="td-with-input">{$forms.reportForm.chclientnumber.control}</td>
  </tr>
  <tr><td><div class="small-screen-form-control-separator"></div></td></tr>
{/if}
{if $show_project}
