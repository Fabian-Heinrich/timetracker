...
class ttClientHelper {
  ...
  static function insert($fields)
  {
    ...
    $client_number = (int) $fields['client_number'];
    $name = $fields['name'];
    ...
    $sql = "insert into tt_clients (team_id, client_number, name, address, tax, projects, status) 
      values ($team_id, ".$mdb2->quote($client_number).", ".$mdb2->quote($name).", ".$mdb2->quote($address).", $tax, ".$mdb2->quote($comma_separated).", ".$mdb2->quote($status).")";
  ...
  static function update($fields)
  {
    ...
    $sql = "update tt_clients set client_number = ".$mdb2->quote($client_number).", name = ".$mdb2->quote($name).", address = ".$mdb2->quote($address).
