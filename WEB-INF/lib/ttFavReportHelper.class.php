...
class ttFavReportHelper {
  ...
  static function insertReport($fields) {
    ...
    $sql = "insert into tt_fav_reports".
      ...
      " show_task, show_end, show_note, show_billable, show_client_number, show_custom_field_1, show_work_units,".
      ...
      $fields['chtask'].", ".$fields['chfinish'].", ".$fields['chnote'].", ".$fields['chbillable'].", ".$fields['chclientnumber']. ", ".$fields['chcf_1'].", ".$fields['chunits'].", ".
  ...
  static function updateReport($fields) {
    ...
    $sql = "update tt_fav_reports set ".
	  ...
	  "show_client_number = " . $fields['chclientnumber'] . ", " .
  ...
  static function saveReport($bean) {
	...
	if (!$bean->getAttribute('chbillable')) $bean->setAttribute('chbillable', 0);
    if (!$bean->getAttribute('chclientnumber')) $bean->setAttribute('chclientnumber', 0);
  ...
  static function loadReport(&$bean) {
    ...
    if ($val) {
      ...
      $bean->setAttribute('chclientnumber', $val['show_client_number']);
