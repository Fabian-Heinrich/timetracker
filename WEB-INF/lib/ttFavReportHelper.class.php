...
class ttFavReportHelper {
  ...
  static function insertReport($fields) {
    ...
    $sql = "insert into tt_fav_reports".
      ...
      " show_task, show_end, show_note, show_billable, show_client_number, show_approved, show_work_units,".
      ...
      $fields['chtask'].", ".$fields['chfinish'].", ".$fields['chnote'].", ".$fields['chbillable'].", ".$fields['chclientnumber']. ", ".$fields['chapproved'].", ".$fields['chunits'].", ".
